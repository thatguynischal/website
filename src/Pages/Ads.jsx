        ...
        <div className="flex  lg:justify-center   items-center  ">
          <div className="flex gap-3  flex-col">
            <p className="text-4xl font-bold">
              ...
              <br /> from more channels?
            </p>
            <p>
              Maximize your online impact with our full-service digital <br />{" "}
              marketing solutions. From SEO and PPC to social media and <br />{" "}
              content marketing, we have the expertise to help you succeed.
            </p>
            <div>
              <button
                type="button"
            ...
            <p className="text-fcolor cursor-pointer">
          ...
          <div className="flex justify-center items-center">
            <div className="flex gap-3 flex-col">
              <p className="text-4xl font-bold">
                ...
                <br /> latest tips and tricks
              </p>
              <p>
                Discover the latest tips and tricks for boosting your website
                performance! <br /> We help you stay ahead of the curve in the
                ever-evolving world of digital <br /> solutions with our tips
                and tricks.
              </p>
              <div>
                <button

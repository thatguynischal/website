...
const Homepage = () => {
  return (
    <div className='mainDiv h-screen relative' style={{ background: "url('./tekgro-solution-gif.gif')" }}>
          ...
          <div className='lg:w-1/2 flex justify-center items-center z-10'>
            <div className='p-20 flex flex-col gap-4'>
              ...
              <p>Join the ranks of successful businesses with our premium digital <br />
                solutions platform. Upgrade to our premium plan today and start <br /> seeing real results.
              </p>
              <div>

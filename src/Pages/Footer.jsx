...
const Footer = () => {
    ...
    const myFlagData = flagData.map((item) => (
        <Flags img={item.img} />
    ))
    return (
        <div className='flex flex-col justify-center items-center gap-4 lg:gap-10 my-24 '>
            <div className='relative flex flex-col justify-center items-center '>
                <img src="./Rectangle.png" alt="" className='rounded-3xl h-96 md:h-56 absolute -z-50 w-full' />
                <div className='px-20 flex flex-col justify-center items-center'>
                    ...
                    <div className='lg:flex gap-2 my-6'>
            ...
            <div className='lg:flex grid gap-16 p-10 lg:px-36'>
                <div className='flex flex-col gap-4'>
                    ...
                    <p className='text-button text-3xl font-bold'>We will help you built your Online platform</p>
                    <p className='text-lg'>If you're looking for a reliable and experienced partner for your digital needs. Contact us today and help your business grow.</p>
                    <div>
                ...
                <div className='flex flex-col gap-4'>
                    <img src="./xo2.gif" alt="" className='h-16 w-16' />
                    <p className='text-fcolor text-lg font-bold'>Check Pricing</p>
                    <p className=''>Lorem ipsum dolor sit a corporis architecto quidem? Aliquam, ut.</p>
                ...
                <div className='flex flex-col gap-4'>
                    <img src="./xo.gif" alt="" className='h-16 w-16' />
            ...
            <div className='lg:flex flex-col p-5 lg:p-20 gap-10 border-t-2 border-b-2'>
                ...
                <div className=' gap-5 lg:gap-28 grid grid-cols-2 lg:flex justify-center'>
                    <div>
                        <p className='text-xl flex items-center -ml-14 text-button font-bold'><BsDot size={50} className='font-extrabold ' /> Quick Link</p>
                        <p>Tekgro Overview</p>
                        <p>Career</p>
                        <p>Blogs</p>
                        <p>Knowledge Base</p>
                    ...
                    <div>
                        <p className='text-xl flex items-center -ml-12 text-button font-bold'><BsDot size={50} className='font-extrabold ' /> Social Media</p>
                    ...
                    <div>
                        <p className='text-xl flex items-center -ml-12  text-button font-bold'><BsDot size={50} className='font-extrabold ' /> Legal</p>
                        <p>Privacy Policy</p>
                        <p>Disclaimer</p>
                        <p>Terms & Condition</p>
                    </div>
                    ...
                    <div>
                        <p className='text-xl flex items-center -ml-12  text-button font-bold'><BsDot size={50} className='font-extrabold ' /> Australia</p>
                        <p>0280 743 892</p>
                    ...
                    <div>
                        <p className='text-xl flex items-center -ml-12  text-button font-bold'><BsDot size={50} className='font-extrabold ' /> Nepal</p>
                        <p>+977-9802330080</p>
                        <p>support@tekgro.com.au</p>
                        <p>Old Baneshwor</p>
                        <p>Kathmandu</p>
            ...
            <div className='d-flex p-5 lg:px-44 justify-center items-center text-center'>
                <p>Copyright @2023 Upvivid Pty Ltd Trading as TekGro Australia. ACN : 631 588 611</p>
                <p className='my-5'>At Tekgro, we acknowledge and pay respect to the Indigenous peoples of Australia, the Torres Strait Islanders
                    and the Aboriginals, who have a rich cultural heritage that dates back thousands of years. As an organization,
                    we believe in promoting inclusiveness and diversity, and recognizing the unique contributions of Indigenous peoples to the world.</p>
            </div>

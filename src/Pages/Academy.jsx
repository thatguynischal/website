...
const Academy = () => {
  ...
  const myData = partnersData.map((item) => <Partners img={item.img} />);
  return (
    <div className="flex gap-20 flex-col p-5 relative justify-center items-center">
      ...
      <img
        src="./smallcircle.png"
        alt=""
        className="absolute top-44 left-2/4 -z-50"
      />
      <img
        src="./smallcircle.png"
        alt=""
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col text-center justify-center items-center">
          <p>
            Are you ready to take your IT career to the next level? Tekgro
            Academy, a subsidiary of Tekgro Australia, is the leading
          </p>
          <p>
            provider of Information Technology training and education. Our
            courses are designed by industry experts and focus on the
          </p>{" "}
          most in-demand technologies and skills, so you can be confident that
          you're learning the most up-to-date information
        </div>
        <div className="mx-auto">
          ...
          >
            <span className="text-xl">GET ENROLLED</span>
          </button>
        </div>
      </div>
      ...
      <div className="mx-auto text-xl flex flex-col justify-center items-center font-bold">
        <p>
          ...
          <span className="text-slate-500">Awards & Accreditation</span>
        </p>
        <div className="flex gap-4">{myData}</div>
      </div>
    </div>
  );
};
